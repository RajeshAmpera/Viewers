...
//     createHeaderComponentFn: function (React) {
//       return function CustomHeader({ children }) {
//         const onBack = () => {
//           window.location.href = 'http://localhost:8080/system/cases'; // ✅ Replace with your target URL
//         };

//         return React.createElement(
//           'div',
//           { className: 'flex items-center h-full px-4 bg-black text-white' },
//           React.createElement(
//             'button',
//             {
//               onClick: onBack,
//               className: 'mr-4 text-lg font-bold hover:underline',
//               title: 'Go back',
//             },
//             '← Back'
//           ),
...
//       return function CustomHeader({ children }) {
//         const onBack = () => {
//           window.location.href = 'http://localhost:8080/'; //  Replace with your target URL
//         };
